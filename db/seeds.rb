...
Video.create(title: "Adventure Time",
             small_cover: "adventure_time",
             large_cover: "adventure_time",
...
Video.create(title: "Family Guy",
             small_cover: "family_guy",
             large_cover: "family_guy",
...
Video.create(title: "Futurama",
             small_cover: "futurama",
             large_cover: "futurama",
...
Video.create(title: "Regular Show",
             small_cover: "regular_show",
             large_cover: "regular_show",
...
Video.create(title: "South Park",
             small_cover: "south_park",
             large_cover: "south_park",
